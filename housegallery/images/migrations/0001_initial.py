    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt', models.CharField(blank=True, help_text='Max length: 510 characters', max_length=510)),
                ('credit', models.CharField(blank=True, max_length=255)),
                ('description', models.TextField(blank=True, help_text='Optional description or additional information about the image')),
                ('preserve_original', models.BooleanField(default=False, help_text='If unchecked, files will be optimized to high-quality web format (recommended for most uploads). Uses more storage when checked.')),
