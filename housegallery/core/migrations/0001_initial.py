    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', wagtail.fields.StreamField([('normal_link', 9), ('divider', 11)], blank=True, block_lookup={0: ('wagtail.blocks.CharBlock', (), {'help_text': 'Link text to display. Leave blank to use the page/document title or URL as fallback', 'required': False}), 1: ('wagtail.blocks.ChoiceBlock', [], {'choices': [('page', 'Page'), ('external', 'External URL'), ('document', 'Document'), ('email', 'Email Address')], 'help_text': 'Select the type of link you want to create'}), 2: ('wagtail.blocks.PageChooserBlock', (), {'required': False}), 3: ('wagtail.blocks.URLBlock', (), {'required': False}), 4: ('wagtail.documents.blocks.DocumentChooserBlock', (), {'required': False}), 5: ('wagtail.blocks.EmailBlock', (), {'required': False}), 6: ('wagtail.blocks.StructBlock', [[('link_text', 0), ('link_type', 1), ('page', 2), ('external_url', 3), ('document', 4), ('email', 5)]], {}), 7: ('wagtail.blocks.BooleanBlock', (), {'default': False, 'help_text': 'CTA links show up in special places (like the header.)', 'required': False}), 8: ('wagtail.blocks.BooleanBlock', (), {'default': False, 'help_text': 'Want this link to open in a new tab?', 'required': False}), 9: ('wagtail.blocks.StructBlock', [[('link', 6), ('is_cta', 7), ('open_in_new_tab', 8)]], {'icon': 'link'}), 10: ('wagtail.blocks.CharBlock', (), {'help_text': 'Optional text label for this menu section (leave blank for just a line)', 'max_length': 50, 'required': False}), 11: ('wagtail.blocks.StructBlock', [[('label', 10)]], {'icon': 'grip'})})),
            ],
            options={
                'abstract': False,
            },
