...
from .admin_views import BulkAddArtworksView
...
class ArtworkSnippetViewSet(SnippetViewSet):
    ...
    def get_urlpatterns(self):
        # Prepend bulk-add before the default patterns so it doesn't
        # get caught by Wagtail's <pk>/ edit pattern.
        urlpatterns = [
            path(
                "bulk-add/",
                BulkAddArtworksView.as_view(),
                name="bulk_add",
            ),
        ]
